...
class PersistenceFacadeTest {
    ...
    // PersistenceUnitDescriptor aPersistenceUnitDescriptor =
    // persistenceFacade.persistenceUnitBuilder("A")
    ...
    // .build()
    // .build();
    // PersistenceUnitDescriptor bPersistenceUnitDescriptor =
    // persistenceFacade.persistenceUnitBuilder("b")
    // .withPrimitiveAttribute()
    // .name("age")
    // .type(PrimitiveType.INTEGER)
    // .build()
    // .build();
    // persistenceFacade.associationBuilder(aPersistenceUnitDescriptor,
    // bPersistenceUnitDescriptor)
    ...
    // PersistenceUnitDescriptor worldUnitDescriptor =
    // persistenceFacade.persistenceUnitBuilder(" The beau-tiful word_")
    // .withPrimitiveAttribute()
    // .name("word age__ _ -")
    ...
    // .build()
    // .build();
    // PersistenceUnitDescriptor humanUnitDescriptor =
    // persistenceFacade.persistenceUnitBuilder("human")
    // .withPrimitiveAttribute()
    // .name("age")
    // .type(PrimitiveType.INTEGER)
    // .build()
    ...
    // .build();
    // persistenceFacade.associationBuilder(worldUnitDescriptor,
    // humanUnitDescriptor)
    // .aggregationKind(AggregationKind.COMPOSITE)
    // .containerAttribute()
