...
public class ProjectPresenter implements Initializable {
    ...
    private void initializeStage() {
        ...
        window.yProperty()
                .addListener(changeListenerRegistryHelper.registerChangeListener((y, oldY, newY) -> {
        ...
        persistenceModel = presenter.getPersistenceModel();// TODO: consider
                                                           // extracting these
                                                           // lines to
                                                           // fx service
        configurationModel = configurationController.getGlobalConfigurationModel();
        // configurationModel =
        // configurationDomainService.loadConfigurationModel();
        // StartledFrogDiagram diagram = (StartledFrogDiagram)
        // xRoot.getDiagram();
    ...
    public void selectNewPersistenceUnitTool() throws IllegalOperationException {
        ...
        // NodeChooser tool = new NodeChooser(diagram, new Point2D(200, 200),
        // graphics, false);
        // tool.addChoice(new
        // PersistenceUnitNode(diagram.getPersistenceDescriptor().addNewPersistenceUnit("New
        // Unit")));
