...
public class SystemCallCreateStartledFrogProjectService extends AbstractCreateStartledFrogProjectService {
    ...
    public SystemCallCreateStartledFrogProjectService(
            CreateProjectProperties globalProperties,
    ...
    // PersistenceUnitDescriptor bulb =
    // persistenceFacade.persistenceUnitBuilder("bulb")
    ...
    // .build()
    // .build();
    // PersistenceUnitDescriptor chandelier =
    // persistenceFacade.persistenceUnitBuilder("chandelier")
    // .withPrimitiveAttribute()
    // .name("color")
