...
public class TranslatedTablesData {
    ...
    public Column getJoinColumnByReferentialAttribute(@NonNull ReferentialAttribute referentialAttribute) {
        ...
        // return parentTableColumn;
        // }
        // ReferentialAttribute anotherAttr =
        // TranslatorHelper.getAnotherAttributeFromAssociation(referentialAttribute);
        // String anotherPuName = anotherAttr.getParentClassifier().getName();
        //
        // return
        // getColumnByReferentialAttributeAndPersistenceUnitName(anotherAttr,
        // anotherPuName);
    }

    private Column getColumnByReferentialAttributeAndPersistenceUnitName(
    ...
    public void addPersistenceUnitEntityTable(
