...
public class AssociationValidator {
    ...
    private static void assertCommonRulesAreSatisfied(
    ...
    private static void associationMustNotBeBidirectional(
    ...
    private static void associationMustNotBeOneToOne(
            ReferentialAttributeModel containerAttribute,
            ReferentialAttributeModel elementAttribute
    ) throws IllegalOperationException {
