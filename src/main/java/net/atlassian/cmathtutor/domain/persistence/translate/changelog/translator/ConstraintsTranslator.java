...
public class ConstraintsTranslator {
    ...
    public Constraints translateArity(
            AttributeArity translatedAttributeArity,
    ...
    private Constraints translateArityToConstraints(
            AttributeArity translatedAttributeArity,
    ...
    public Constraints translateArityToJoinTableColumnConstraints(
            AttributeArity translatedAttributeArity,
            AttributeArity referencedAttributeArity
    ) {
        return Constraints.builder()
