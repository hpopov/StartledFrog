...
public class AttributeToFieldTranslator {
    ...
    public Variable translatePrimaryReferentialAttribute(
            ReferentialAttribute primaryAttr,
    ...
    private AnnotationInstance<?> getArityAnnotationForPrimaryReferentialAttribute(
            ReferentialAttribute primaryAttr,
    ...
    public Variable translateSecondaryReferentialAttribute(
            ReferentialAttribute secondaryAttr,
    ...
    private AnnotationInstance<?> getArityAnnotationForSecondaryReferentialAttribute(
            ReferentialAttribute secondaryAttr,
