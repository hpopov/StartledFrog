...
public class StartledFrogAddRemoveCommand extends AddRemoveCommand {
    ...
    public static StartledFrogAddRemoveCommand newStartledFrogAddCommand(
    ...
    public static AnimationCommand newStartledFrogAddCommand(
            StartledFrogDiagram diagram,
    ...
    public static StartledFrogAddRemoveCommand newStartledFrogRemoveCommand(
            StartledFrogDiagram diagram,
            XShape[] shapes
    ) {
