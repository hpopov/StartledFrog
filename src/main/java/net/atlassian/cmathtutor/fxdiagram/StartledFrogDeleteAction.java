...
public class StartledFrogDeleteAction extends DeleteAction {
    ...
    public void perform(XRoot root) {
        ...
        Function1<XNode, ObservableList<XConnection>> _function = (it) -> { return it.getIncomingConnections(); };
        ...
        Function1<XNode, ObservableList<XConnection>> _function_1 = (it) -> { return it.getOutgoingConnections(); };
        ...
        Function1<XShape, Boolean> _function_2 = (it) -> { return it instanceof XNode || it instanceof XConnection; };
        ...
        Function<XControlPoint, XConnection> _function_3 = (it) -> { return this.getConnection(it); };
        ...
        Function<XShape, XDiagram> _function_5 = (it) -> { return CoreExtensions.getDiagram(it); };
        ...
        Function1<XDiagram, StartledFrogAddRemoveCommand> _function_6 = (diagram) -> {
            ...
            // TODO: change it, now it works only because xRoot contain the only
            // one
            // StartledFrogDiagram!
